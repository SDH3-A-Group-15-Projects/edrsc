    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        val wordsRemembered = selectedWords.size // 0-5
                        val animalCount = animalsText
                            .split(",", " ", "\n")
                            .filter{it.isNotBlank()}
                            .size

                        val animalsScore = (animalCount.coerceIn(0, 15) / 3.0)// around 0-5
                        val memoryScore = (wordsRemembered + animalsScore) / 2

                        onMemoryScored(memoryScore)
                        onFinish()
                    },
                    modifier = Modifier
                        .fillMaxWidth()
